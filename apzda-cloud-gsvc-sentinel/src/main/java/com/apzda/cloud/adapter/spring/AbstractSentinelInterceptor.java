...
import com.apzda.cloud.adapter.spring.config.BaseWebMvcConfig;
 ...
 * deal with the initial request. So we use <b>reference count</b> to track in dispatching
 * "onion" though which we could figure out whether we are in initial type "REQUEST". That
 * means the sub-requests which we rarely meet in practice will NOT be recorded in
 * Sentinel.
 * <p>
 * How to implement a forward sub-request in your action: <pre>
 * initialRequest() {
...
public abstract class AbstractSentinelInterceptor implements HandlerInterceptor {
    ...
    public static final String SENTINEL_SPRING_WEB_CONTEXT_NAME = "sentinel_gsvc_context";
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex)
        ...
        if (entry == null) {
            // should not happen
            RecordLog.warn("[{}] No entry found in request, key: {}", getClass().getSimpleName(),
                    baseWebMvcConfig.getRequestAttributeName());
            return;
        }
    ...
    protected void handleBlockException(HttpServletRequest request, HttpServletResponse response, BlockException e)
        ...
        if (baseWebMvcConfig.getBlockExceptionHandler() != null) {
            ...
            // Throw BlockException directly. Users need to handle it in Spring global
            // exception handler.
            throw e;
        }
    }
