 ...
 */
package com.apzda.cloud.adapter.servlet;
...
import com.apzda.cloud.adapter.servlet.config.WebServletConfig;
import com.apzda.cloud.adapter.servlet.util.FilterUtil;
...
public class CommonFilter implements Filter {
    ...
    /**
     * If enabled, use the default context name, or else use the URL path as the context
     * name, {@link WebServletConfig#WEB_SERVLET_CONTEXT_NAME}. Please pay attention to
     * the number of context (EntranceNode), which may affect the memory footprint.
     *
     * @since 1.7.0
     */
