...
public class GatewayServiceConfigure {
    private final HttpClientProperties httpClientConfig;
    ...
    public Duration getReadTimeout(int index, String methodName) {
        ...
        // httpClient
        val responseTimeout = httpClientConfig.getResponseTimeout();
    ...
    public Duration getConnectTimeout(int index, String methodName) {
        ...
        // httpClient
        val responseTimeout = httpClientConfig.getConnectTimeout();
        if (responseTimeout != null) {
            return readTimeout;
        }
        // default
