...
public final class GreetingServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<HelloRequest,
      HelloResponse> getSayHeiMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sayHei",
      requestType = HelloRequest.class,
      responseType = HelloResponse.class,
  ...
  public static io.grpc.MethodDescriptor<HelloRequest,
    ...
    if ((getSayHeiMethod = GreetingServiceGrpc.getSayHeiMethod) == null) {
      synchronized (GreetingServiceGrpc.class) {
        if ((getSayHeiMethod = GreetingServiceGrpc.getSayHeiMethod) == null) {
          GreetingServiceGrpc.getSayHeiMethod = getSayHeiMethod =
              io.grpc.MethodDescriptor.<HelloRequest, HelloResponse>newBuilder()
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void sayHei(HelloRequest request,
                        io.grpc.stub.StreamObserver<HelloResponse> responseObserver) {
  ...
  public static final class GreetingServiceStub
     ...
     * </pre>
     */
    public void sayHei(HelloRequest request,
                       io.grpc.stub.StreamObserver<HelloResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncServerStreamingCall(
          getChannel().newCall(getSayHeiMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public io.grpc.stub.StreamObserver<HelloRequest> sayHi(
      ...
      return io.grpc.stub.ClientCalls.asyncBidiStreamingCall(
          getChannel().newCall(getSayHiMethod(), getCallOptions()), responseObserver);
    }
  }
  ...
  public static final class GreetingServiceBlockingStub
     ...
     * </pre>
     */
    public java.util.Iterator<HelloResponse> sayHei(
        HelloRequest request) {
      return io.grpc.stub.ClientCalls.blockingServerStreamingCall(
          getChannel(), getSayHeiMethod(), getCallOptions(), request);
    }
  }
